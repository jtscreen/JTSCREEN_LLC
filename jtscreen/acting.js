...
//Swipe Function
let theaterSwipe = document.getElementById("hidden-theater");
let filmSwipe = document.getElementById("hidden-film");
let otherSwipe = document.getElementById("hidden-other");

let touchStartX = 0;
let touchEndX = 0;

//theater
theaterSwipe.addEventListener('touchstart', (e) => {
  touchStartX = e.touches[0].clientX;
  console.log("touch start")
});
theaterSwipe.addEventListener('touchmove', (e) => {
  touchEndX = e.touches[0].clientX;
  console.log("touch move")
});
theaterSwipe.addEventListener('touchend', () => {
...
//film
filmSwipe.addEventListener('touchstart', (e) => {
  touchStartX = e.touches[0].clientX;
});
filmSwipe.addEventListener('touchmove', (e) => {
  touchEndX = e.touches[0].clientX;
});
filmSwipe.addEventListener('touchend', () => {
  const swipeDistance = touchEndX - touchStartX;
  const threshold = 50; // Minimum distance for a swipe
...
//other
otherSwipe.addEventListener('touchstart', (e) => {
  touchStartX = e.touches[0].clientX;
});
otherSwipe.addEventListener('touchmove', (e) => {
  touchEndX = e.touches[0].clientX;
});
otherSwipe.addEventListener('touchend', () => {
  const swipeDistance = touchEndX - touchStartX;
  const threshold = 50; // Minimum distance for a swipe
